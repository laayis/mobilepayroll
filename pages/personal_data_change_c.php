...
<form name="personalDataForm" method="post" action="/EssPersonal/updatePersonalInfo.do;jsessionid=9DFF23D48770D638A6BA6D5A70ED948E">
<table width="800"   border="0" cellpadding="0" cellspacing="0"  align="center">
<tr><td>
<div style="display: none; visibility: invisible;">
<input type="text" name="country" maxlength="2" size="5" value="US" class="entertext">
</div>
			<!-- US Associate Info -->
	...
	<table width="100%" border="2" cellpadding="0" cellspacing="0" bordercolor="#EFEFE4" >
		...
		<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr><td width="37%" valign="middle" class="normal"> 
						...
						<input type="text" name="fname" maxlength="30" size="15" value="WINICIUS" onfocus="displayNameNote()" class="entertext" id="fname">
						<span ><strong>M.I.:
						</strong></span> 
                        <input type="text" name="mname" maxlength="1" size="1" value="" onfocus="displayNameNote()" class="entertext" id="mname">
						<strong><span>Last:
						</span></strong> 
                        <input type="text" name="lname" maxlength="30" size="15" value="SIQUEIRA" onfocus="displayNameNote()" class="entertext" id="lname">
					...
					<tr><td class="normal"> 
						...
						<input type="text" name="address1" maxlength="24" size="35" value="200 177TH DR." onfocus="displayAdrNote()" class="entertext" id="address1">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Address line 2:</strong></div></td>
						<td><div align="left"><strong>&nbsp; 
						<input type="text" name="address2" maxlength="24" size="35" value="303" onfocus="displayAdrNote()" class="entertext" id="address2">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>City:</strong></div></td>
						<td><div align="left"><strong> &nbsp; 
						<input type="text" name="city" size="24" value="SUNNY ISLES" onfocus="displayAdrNote()" class="entertext" id="city">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
					...
					<tr><td class="normal"> 
						...
						<td><div align="left"><strong> &nbsp; 
						<input type="text" name="zipCode" maxlength="10" size="10" value="33160" onfocus="displayAdrNote()" class="entertext" id="zipCode">
						</strong></div></td>
						</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Primary:</strong></div></td>
						<td><div align="left"><strong>&nbsp; 
						<input type="text" name="primaryPhone1" maxlength="3" size="3" value="786" class="entertext" id="primaryPhone1"> - 
						<input type="text" name="primaryPhone2" maxlength="3" size="3" value="488" class="entertext" id="primaryPhone2"> -
						<input type="text" name="primaryPhone3" maxlength="4" size="4" value="5097" class="entertext" id="primaryPhone3">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Secondary:</strong></div></td>
						<td><div align="left"><strong>&nbsp; 
						<input type="text" name="secondaryPhone1" maxlength="3" size="3" value="" class="entertext" id="secondaryPhone1"> - 
						<input type="text" name="secondaryPhone2" maxlength="3" size="3" value="" class="entertext" id="secondaryPhone2"> -
						<input type="text" name="secondaryPhone3" maxlength="4" size="4" value="" class="entertext" id="secondaryPhone3">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
...
<table width="100%" border="2" cellpadding="0" cellspacing="0" bordercolor="#EFEFE4">
		...
		<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr><td width="37%" class="normal"> 
						...
						<td><div align="left"><strong>&nbsp; 
						<input type="text" name="emeECName" maxlength="30" size="35" value="" class="entertext" id="emeECName">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						...
						<td ><div align="left"><strong>&nbsp; 
						<input type="text" name="emeECPhone1Part1" maxlength="3" size="3" value="" class="entertext" id="emeECPhone1Part1"> - 
						<input type="text" name="emeECPhone1Part2" maxlength="3" size="3" value="" class="entertext" id="emeECPhone1Part2"> -
						<input type="text" name="emeECPhone1Part3" maxlength="4" size="4" value="" class="entertext" id="emeECPhone1Part3">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Phone Number:
						...
						<td ><div align="left"><strong>&nbsp; 
						<input type="text" name="emeECPhone2Part1" maxlength="3" size="3" value="" class="entertext" id="emeECPhone2Part1"> - 
						<input type="text" name="emeECPhone2Part2" maxlength="3" size="3" value="" class="entertext" id="emeECPhone2Part2"> -
						<input type="text" name="emeECPhone2Part3" maxlength="4" size="4" value="" class="entertext" id="emeECPhone2Part3">
						</strong></div></td>
					</tr>
					<tr><td >&nbsp;</td>
					...
					<tr><td class="normal"> 
						...
						<td ><div align="left"><strong> &nbsp; 
						<input type="text" name="emeSCName" maxlength="30" size="35" value="" class="entertext" id="emeSCName">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Phone Number:
						...
						<td ><div align="left"><strong>&nbsp;
						<input type="text" name="emeSCPhone1Part1" maxlength="3" size="3" value="" class="entertext" id="emeSCPhone1Part1"> - 
						<input type="text" name="emeSCPhone1Part2" maxlength="3" size="3" value="" class="entertext" id="emeSCPhone1Part2"> -
						<input type="text" name="emeSCPhone1Part3" maxlength="4" size="4" value="" class="entertext" id="emeSCPhone1Part3">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Phone Number:
						...
						<td><div align="left"><strong> &nbsp; 
						<input type="text" name="emeSCPhone2Part1" maxlength="3" size="3" value="" class="entertext" id="emeSCPhone2Part1"> - 
						<input type="text" name="emeSCPhone2Part2" maxlength="3" size="3" value="" class="entertext" id="emeSCPhone2Part2"> -
						<input type="text" name="emeSCPhone2Part3" maxlength="4" size="4" value="" class="entertext" id="emeSCPhone2Part3">
						</strong></div></td>
					</tr>
					<tr><td>&nbsp;</td>
						<td ><div align="left"></div></td>
					...
					<tr><td class="normal"> 
						<div align="right"><strong>Other Contact: 
						</strong></div></td>
						<td ><div align="left"><strong>&nbsp; 
						<input type="text" name="emeOCName" maxlength="30" size="35" value="" class="entertext" id="emeOCName">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Phone Number:
						...
						<td ><div align="left"><strong> &nbsp; 
						<input type="text" name="emeOCPhone1Part1" maxlength="3" size="3" value="" class="entertext" id="emeOCPhone1Part1"> -  
						<input type="text" name="emeOCPhone1Part2" maxlength="3" size="3" value="" class="entertext" id="emeOCPhone1Part2"> -
						<input type="text" name="emeOCPhone1Part3" maxlength="4" size="4" value="" class="entertext" id="emeOCPhone1Part3">
						</strong></div></td>
					</tr>
					<tr><td class="normal"> 
						<div align="right"><strong>Phone Number:
						...
						<td ><div align="left"><strong>&nbsp; 
						<input type="text" name="emeOCPhone2Part1" maxlength="3" size="3" value="" class="entertext" id="emeOCPhone2Part1"> - 
						<input type="text" name="emeOCPhone2Part2" maxlength="3" size="3" value="" class="entertext" id="emeOCPhone2Part2"> -
						<input type="text" name="emeOCPhone2Part3" maxlength="4" size="4" value="" class="entertext" id="emeOCPhone2Part3">
						</strong></div></td>
					</tr>
			</table></td>
		</tr>
...
<br /> 
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr><td><br /> 
			<div align="left">
				<input type="button" id="sub" value="Submit" class="entertext" onclick="deleteConfirmation()" />
			</div>
			<br />
			</td>
		</tr>
